...
int Csockets::createSocket (void)
{
    int sockfd;
...
void Csockets::bindToAddr (int sockfd, const struct sockaddr_in& addr)
{
    int ret;
...
void Csockets::listenQueue (int sockfd)
{
    int ret;
...
int Csockets::acceptConnect (int sockfd, struct sockaddr_in* paddr)
{
...
int Csockets::connectToServer (int sockfd, const struct sockaddr_in& addr)
{
    int res;
...
void Csockets::closeSocket (int sockfd)
{
    if (sockfd)
        ::close (sockfd);
}

void Csockets::shutdownWrite (int sockfd)
{
...
void Csockets::getHostPort (char* buf, size_t size, \
...
void Csockets::setHostPort (const char* ip, uint16_t port, \
...
int Csockets::getSocketError (int sockfd)
{
    int optval;
...
struct sockaddr_in Csockets::getLocalAddr (int sockfd)
{
...
struct sockaddr_in Csockets::getRemoteAddr (int sockfd)
{
...
bool Csockets::isSelf (int sockfd)
{
